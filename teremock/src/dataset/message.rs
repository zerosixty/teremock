...
macro_rules! Message {
    (
        ...
        impl crate::dataset::IntoUpdate for $name {
            ...
            ///
            /// let mock_message = teremock::MockMessageText::new();
...
impl MockEditedMessage {
    ...
    /// use chrono::Utc;
    ///
    /// let message = teremock::MockMessageText::new().edit_date(Utc::now()).build();
    /// let edited_message = teremock::MockEditedMessage::new(message.clone());
...
impl MockMessageDice {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageDice::new()
    ///     .value(2)
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageDice::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.dice().unwrap().emoji, teremock::MockMessageDice::EMOJI);  // EMOJI is a default value
    /// ```
    ///
...
impl MockMessageInvoice {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageInvoice::new()
    ///     .title("Some title")
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageInvoice::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.invoice().unwrap().currency, teremock::MockMessageInvoice::CURRENCY);  // CURRENCY is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageNewChatMembers {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageNewChatMembers::new()
    ///     .new_chat_members(vec![teremock::MockUser::new().id(123).build()])
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageNewChatMembers::new();
    /// let message = mock_message.build();
