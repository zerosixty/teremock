...
impl MockMessageText {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageText::new()
    ///     .text("/start")
    ///     .build();
    ...
    /// assert_eq!(message.text().unwrap(), teremock::MockMessageText::TEXT.to_string());  // TEXT is a default value
    /// ```
    ///
...
impl MockMessageAnimation {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageAnimation::new()
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageAnimation::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.has_media_spoiler(), teremock::MockMessageAnimation::HAS_MEDIA_SPOILER);  // HAS_MEDIA_SPOILER is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageAudio {
    ...
    /// let message = teremock::MockMessageAudio::new()
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageAudio::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.audio().unwrap().duration, teremock::MockMessageAudio::DURATION);  // DURATION is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageContact {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageContact::new()
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageContact::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.contact().unwrap().phone_number, teremock::MockMessageContact::PHONE_NUMBER);  // PHONE_NUMBER is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageDocument {
    ...
    /// let message = teremock::MockMessageDocument::new()
    ///     .file_id(FileId::from("12345"))
    ///     .build();
    /// assert_eq!(message.document().unwrap().file.id, FileId::from("12345"));
    /// ```
    ///
    pub fn new() -> Self {
        Self::new_message_common(
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageDocument::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.document().unwrap().file.id, teremock::MockMessageDocument::FILE_ID.into());  // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageGame {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageGame::new()
    ///     .title("title")
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageGame::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.game().unwrap().title, teremock::MockMessageGame::TITLE);  // TITLE is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageVenue {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageVenue::new()
    ///     .title("title")
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageVenue::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.venue().unwrap().title, teremock::MockMessageVenue::TITLE);  // TITLE is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageLocation {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageLocation::new()
    ///     .latitude(50.0)
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageLocation::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.location().unwrap().latitude, teremock::MockMessageLocation::LATITUDE);  // LATITUDE is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessagePhoto {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessagePhoto::new()
    ///     .has_media_spoiler(true)
    ///     .photo(vec![teremock::MockPhotoSize::new().build(); 3])
    ///     .build();
    /// assert_eq!(message.has_media_spoiler(), true);
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessagePhoto::new();
    /// let message = mock_message.build();
...
impl MockMessagePoll {
    ...
    /// let message = teremock::MockMessagePoll::new()
    ///     .poll_id(PollId::from("123456"))
    ///     .build();
    ///
    /// assert_eq!(message.poll().unwrap().id, PollId::from("123456"));
    /// ```
    ///
    pub fn new() -> Self {
        Self::new_message_common(
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessagePoll::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.poll().unwrap().id, teremock::MockMessagePoll::POLL_ID.into()); // POLL_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageSticker {
    ...
    /// ```
    /// use teloxide::types::FileId;
    /// let message = teremock::MockMessageSticker::new().file_id(FileId::from("12345")).build();
    ///
    /// assert_eq!(message.sticker().unwrap().file.id, FileId::from("12345"));
    /// ```
    ///
    pub fn new() -> Self {
        Self::new_message_common(
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageSticker::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.sticker().unwrap().file.id, teremock::MockMessageSticker::FILE_ID.into()); // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageVideo {
    ...
    /// use teloxide::types::FileId;
    /// let message =
    /// teremock::MockMessageVideo::new().video(teremock::MockVideo::new().file_id(FileId::from("12345")).build()).build();
    /// assert_eq!(message.video().unwrap().file.id, FileId::from("12345"));
    /// ```
    ///
    pub fn new() -> Self {
        Self::new_message_common(
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageVideo::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.video().unwrap().file.id, teremock::MockVideo::FILE_ID.into()); // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageVideoNote {
    ...
    /// # Example
    /// ```
    /// let message = teremock::MockMessageVideoNote::new().length(50_u32).build();
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageVideoNote::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.video_note().unwrap().file.id, teremock::MockMessageVideoNote::FILE_ID.into());  // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageVoice {
    ...
    /// ```
    /// use teloxide::types::Seconds;
    /// let message = teremock::MockMessageVoice::new().duration(Seconds::from_seconds(1)).build();
    ...
    /// # Example
    /// ```
    /// let mock_message = teremock::MockMessageVoice::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.voice().unwrap().file.id, teremock::MockMessageVoice::FILE_ID.into());  // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
