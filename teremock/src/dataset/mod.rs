//! A set of mocked structs for testing purposes. Read more in teremock crate.
...
impl MockUser {
    ...
    /// # Examples
    /// ```
    /// let user = teremock::MockUser::new()
    ///     .id(12345678)
    ///     .build();
    ...
    /// # Examples
    /// ```
    /// let mock_user = teremock::MockUser::new();
    /// let user = mock_user.build();
    /// assert_eq!(user.id.0 as u64, teremock::MockUser::ID);  // ID is a default value
    /// ```
    ///
...
impl MockMe {
    ...
    /// # Examples
    /// ```
    /// let mock_me = teremock::MockMe::new();
    /// let me = mock_me.build();
    /// assert_eq!(me.id.0 as u64, teremock::MockMe::ID);  // ID is a default value
    /// ```
    ///
...
impl MockChatPhoto {
    ...
    /// let chat_photo = teremock::MockChatPhoto::new()
    ///     .small_file_id(FileId::from("small_file_id"))
    ///     .build();
    /// assert_eq!(chat_photo.small_file_id, FileId::from("small_file_id"));
    /// ```
    ///
    pub fn new() -> Self {
        Self {
    ...
    /// # Examples
    /// ```
    /// let mock_chat_photo = teremock::MockChatPhoto::new();
    /// let chat_photo = mock_chat_photo.build();
    /// assert_eq!(
    ///     chat_photo.small_file_id,
    ///     teremock::MockChatPhoto::SMALL_FILE_ID.into()
...
impl MockPhotoSize {
    ...
    /// # Examples
    /// ```
    /// let photo_size = teremock::MockPhotoSize::new()
    ///     .width(90_u32)
    ///     .build();
    ...
    /// # Examples
    /// ```
    /// let mock_photo_size = teremock::MockPhotoSize::new();
    /// let photo_size = mock_photo_size.build();
    /// assert_eq!(photo_size.width, teremock::MockPhotoSize::WIDTH); // WIDTH is a default value
    /// ```
    ///
...
impl MockVideo {
    ...
    /// # Examples
    /// ```
    /// let video = teremock::MockVideo::new()
    ///     .width(640_u32)
    ///     .build();
    ...
    /// # Examples
    /// ```
    /// let mock_video = teremock::MockVideo::new();
    /// let video = mock_video.build();
    /// assert_eq!(video.width, teremock::MockVideo::WIDTH); // WIDTH is a default value
    /// ```
    ///
...
impl MockLinkPreviewOptions {
    ...
    /// # Examples
    /// ```
    /// let link_preview_options = teremock::MockLinkPreviewOptions::new()
    ///     .is_disabled(true)
    ///     .build();
    ...
    /// # Examples
    /// ```
    /// let mock_link_preview_options = teremock::MockLinkPreviewOptions::new();
...
impl From<MockUser> for User {
    fn from(mock: MockUser) -> Self {
        mock.build()
    }
}

impl From<MockMe> for Me {
    fn from(mock: MockMe) -> Self {
        mock.build()
    }
}

impl From<MockChatPhoto> for ChatPhoto {
    fn from(mock: MockChatPhoto) -> Self {
        mock.build()
    }
}
...
impl From<MockPhotoSize> for PhotoSize {
    fn from(mock: MockPhotoSize) -> Self {
        mock.build()
    }
}

impl From<MockVideo> for Video {
    fn from(mock: MockVideo) -> Self {
        mock.build()
    }
}

impl From<MockLinkPreviewOptions> for LinkPreviewOptions {
    fn from(mock: MockLinkPreviewOptions) -> Self {
        mock.build()
    }
}
